...
const currencies = [
  ...
  { value: "HKD", label: "HK$ - Hong Kong Dollar", symbol: "HK$" },
  { value: "NOK", label: "kr - Norwegian Krone", symbol: "kr" },
  { value: "SEK", label: "kr - Swedish Krona", symbol: "kr" },
  { value: "DKK", label: "kr - Danish Krone", symbol: "kr" },
  { value: "NZD", label: "NZ$ - New Zealand Dollar", symbol: "NZ$" },
  { value: "MXN", label: "$ - Mexican Peso", symbol: "$" },
  { value: "BRL", label: "R$ - Brazilian Real", symbol: "R$" },
  { value: "ZAR", label: "R - South African Rand", symbol: "R" },
  { value: "THB", label: "฿ - Thai Baht", symbol: "฿" },
  { value: "TRY", label: "₺ - Turkish Lira", symbol: "₺" },
  { value: "RUB", label: "₽ - Russian Ruble", symbol: "₽" },
  { value: "PLN", label: "zł - Polish Złoty", symbol: "zł" },
  ...
  { value: "KES", label: "KSh - Kenyan Shilling", symbol: "KSh" },
  { value: "UGX", label: "USh - Ugandan Shilling", symbol: "USh" },
  { value: "TZS", label: "TSh - Tanzanian Shilling", symbol: "TSh" },
  { value: "RWF", label: "FRw - Rwandan Franc", symbol: "FRw" },
  { value: "GHS", label: "₵ - Ghanaian Cedi", symbol: "₵" },
  { value: "MAD", label: "د.م. - Moroccan Dirham", symbol: "د.م." },
  { value: "ETB", label: "Br - Ethiopian Birr", symbol: "Br" },
];
