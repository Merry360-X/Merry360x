          ...
          <div className="space-y-6">
            ...
            <div>
              <DraggableMediaGrid
                ...
                description="Upload exterior photos/videos. Drag to rearrange order (first photo is Cover)."
            ...
            <div>
              <DraggableMediaGrid
                ...
                description="Upload interior photos/videos. Drag photos to arrange them."
                columnsClass="grid-cols-2 sm:grid-cols-3 md:grid-cols-4"
