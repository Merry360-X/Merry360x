-- Fix get_staff_dashboard_metrics to use correct booking_status enum values
-- Replace 'paid' with 'completed' since booking_status doesn't have 'paid'
...
BEGIN
  ...
  -- Calculate gross revenue (sum of confirmed and completed bookings)
