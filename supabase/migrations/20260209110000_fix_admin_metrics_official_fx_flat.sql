-- Fix admin_dashboard_metrics to use official BNR FX rates
-- and return a flat JSON shape matching the frontend Metrics type
...
BEGIN
    ...
    -- Build flat result matching Metrics type
...
COMMENT ON FUNCTION admin_dashboard_metrics() IS 'Returns flat dashboard metrics with revenue converted to RWF using official BNR FX rates.';
