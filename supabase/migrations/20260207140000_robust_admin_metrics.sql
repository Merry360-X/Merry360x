-- Simplified admin_dashboard_metrics with better error handling
-- Revenue converted to RWF (1 USD = 1350 RWF)
...
COMMENT ON FUNCTION admin_dashboard_metrics() IS 'Returns dashboard metrics with revenue in RWF. Individual queries handle errors gracefully.';
