        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width:560px;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
          <tr>
            <td style="padding:28px 28px 12px;text-align:center;">
              <img src="https://merry360x.com/brand/logo.png" alt="Merry Moments" width="44" height="44" style="display:inline-block;border-radius:10px;" />
            </td>
          </tr>
          <tr>
            <td style="padding:0 28px 8px;text-align:center;">
              ${eyebrow ? `<p style="margin:0 0 8px;color:#6b7280;font-size:11px;letter-spacing:.08em;text-transform:uppercase;">${escapeHtml(eyebrow)}</p>` : ""}
              <h1 style="margin:0;color:#111827;font-size:24px;line-height:1.3;">${escapeHtml(title || "Update")}</h1>
              ${subtitle ? `<p style="margin:10px 0 0;color:#4b5563;font-size:14px;line-height:1.6;">${escapeHtml(subtitle)}</p>` : ""}
            </td>
          </tr>
          <tr><td style="padding:16px 28px 0;"><div style="height:1px;background:#e5e7eb;"></div></td></tr>
          <tr>
