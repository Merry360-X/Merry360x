...
export function renderMinimalEmail({
  ...
  ctaText,
  ctaUrl,
  footerText = "Merry360X · Book local. Travel better.",
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-card" style="max-width:560px;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
          <tr>
            <td style="padding:28px 28px 12px;text-align:center;">
              <div style="display:inline-block;padding:8px 12px;background:#ffffff;border-radius:14px;box-shadow:0 2px 8px rgba(0,0,0,0.08);border:1px solid #e5e7eb;">
                <img src="${escapeHtml(lightLogoUrl)}" alt="Merry360X" width="48" height="48" class="logo-light" style="display:inline-block;border-radius:8px;vertical-align:middle;" />
                <img src="${escapeHtml(darkLogoUrl || lightLogoUrl)}" alt="Merry360X" width="48" height="48" class="logo-dark" style="border-radius:8px;vertical-align:middle;" />
              </div>
            </td>
          </tr>
          <tr>
...
<body style="margin: 0; padding: 0; background-color: #0d2818; background-image: linear-gradient(180deg, #134e4a 0%, #064e3b 100%); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #111827; -webkit-font-smoothing: antialiased;">
          ...
          <tr>
            <td style="background-color: #f8fafc; padding: 18px 24px; text-align: center; border-top: 1px solid #e2e8f0;">
              ...
              <p style="margin: 0; font-size: 11px; color: #94a3b8;">
                &copy; ${new Date().getFullYear()} Merry 360 Experiences. All rights reserved.
              </p>
            </td>
          </tr>
