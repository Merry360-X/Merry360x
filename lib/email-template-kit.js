...
const DEFAULT_LIGHT_LOGO = "https://merry360x.com/brand/dark_mode.png";
...
export function generateEnhancedBookingConfirmationHtml(booking) {
  ...
  const rawAddress = booking.address || booking.propertyAddress || booking.meetingPoint || "";
  const rawLocation = booking.location || booking.city || "";
  let displayAddress = "";
  if (rawAddress && rawLocation && !rawAddress.toLowerCase().includes(rawLocation.toLowerCase())) {
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: rgba(255, 255, 255, 0.98); border: 2px solid #ffffff; border-radius: 20px; margin-top: -36px; position: relative; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.12); text-align: center;">
                <tr>
                  <td style="padding: 24px 22px 20px; text-align: center;">
                    ...
                    <!-- Top Logo Icon -->
                    <div style="margin-bottom: 12px;">
                      <img src="https://merry360x.com/brand/logo.png" alt="Merry360X" width="52" height="52" style="display: inline-block; width: 52px; height: 52px; border-radius: 50%; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" />
                    </div>
